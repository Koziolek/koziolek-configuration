...
# run_diagnostic — uruchamia pre-analyze.sh z fix-comp z dowolnego katalogu roboczego.
...
export -f run_diagnostic hwinfo_cpu hwinfo_motherboard hwinfo_ram hwinfo_gpu hwinfo